...
object CreateSubFolderService {
    ...
    suspend fun createAndEnsureSubFolders(auth: String, mainFolderId: String, name: String, userId: String): Boolean {
    ...
    @JvmStatic
    fun createSubFoldersAsync(auth: String, mainFolderId: String, name: String, userId: String): CompletableFuture<Boolean> {
