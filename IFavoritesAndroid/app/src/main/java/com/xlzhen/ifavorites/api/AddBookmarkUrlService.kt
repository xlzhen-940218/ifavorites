...
object AddBookmarkUrlService {
    ...
    suspend fun addAndEnsureBookmarkUrl(auth: String, folderId: String, link: String): Boolean {
    ...
    @JvmStatic
    fun addBookmarkUrlAsync(auth: String, folderId: String, link: String): CompletableFuture<Boolean> {
